...
#ifndef __PRAAS_CONTROL_PLANE_SERVER_HPP__
#define __PRAAS_CONTROL_PLANE_SERVER_HPP__
...
namespace praas::control_plane {
  ...
  //enum class FunctionBackendType { LOCAL = 0, AWS };
  ...
  struct Server {
    ...
    //    spdlog::error(
    //        "Adding socket to epoll failed, reason: {}", strerror(errno)
    //    );
    //    return false;
    //  }
    //  return true;
