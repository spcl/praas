...
namespace praas::control_plane {
  ...
  //       "Handle client connections and allocation of executors."
  //   );
  //   //options.add_options()(
  //   //    "a,address", "IP address used by this server.",
  ...
  //   //)("backend", "Backend allocating functions. Options: [local, aws].",
  //   //  cxxopts::value<std::string>()
  //   //)("local-server", "Address of the local server.",
  //   //  cxxopts::value<std::string>()
  //   //)("read-timeout", "Read timeout for TCP sockets [ms].",
  //   //  cxxopts::value<int>()->default_value("1000")
  //   //)("https-port", "HTTPS port to listen on.",
  //   //  cxxopts::value<int>()->default_value("8050")
  //   //)("ssl-server-cert", "Path to server certificate file.",
  //   //  cxxopts::value<std::string>()
  //   //)("ssl-server-key", "Path to server key file.",
  //   //  cxxopts::value<std::string>()
  ...
  //  //result.ssl_server_cert =
  //  //    parsed_options["ssl-server-cert"].as<std::string>();
